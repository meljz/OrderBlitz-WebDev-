...
<body id="top">
  ...
  <main>
    <!---------------------------#RESERVATION--------------------------------->
        ...
        <div class="container">
          ...
          <div class="form reservation-form bg-black-10">
            ...
            <form action="" class="form-left">
              ...
              <h2 class="headline-1 text-center">Any Feedback? We're Happy To Hear You</h2>

              <p class="form-text text-center">
                Contact us at <a href="tel:+88123123456" class="link">0912 345 6789 </a>
              ...
              <button type="submit" class="btn btn-secondary">
                <span class="text text-1">Enter</span>

                <span class="text text-2" aria-hidden="true">Enter</span>
              </button>
            ...
            <div class="form-right text-center" style="background-image: url('./assets/images/form-pattern.png')">
              ...
              <a href="tel:+88123123456" class="body-1 contact-number hover-underline">0912 345 6789</a>

              <div class="separator"></div>

              <p class="contact-label">Hau St, Pampanga, Philippines</p>
              ...
              <p class="contact-label">Availablity:</p>
      ...
      <section class="section service bg-dark-orange text-center" aria-label="service">
        <div class="container">

          <p class="section-subtitle label-2">Introducing</p>

          <h2 class="headline-1 section-title">Developers</h2>

          <p class="section-text">
           isipi pa ano ilalagay dito 
          </p>
          ...
          <ul class="grid-list">
              ...
              <div class="service-card">
                ...
                <a href="#" class="has-before hover:shine">
                  <figure class="card-banner img-holder" style="--width: 285; --height: 336;">
                    <img src="./assets/images/testi-avatar.jpg" width="285" height="336" loading="lazy" alt="Breakfast"
                      class="img-cover">
                  </figure>
                </a>
                ...
                <div class="card-content">
                  ...
                  <h3 class="title-4 card-title">
                    <a href="#">Daiz, Rhick Daniel</a>
                  </h3>

                  <a href="#" class="btn-text hover-underline label-2">View</a>
            ...
            <li>
              <div class="service-card">
                ...
                <a href="#" class="has-before hover:shine">
                  <figure class="card-banner img-holder" style="--width: 285; --height: 336;">
                    <img src="./assets/images/testi-avatar.jpg" width="285" height="336" loading="lazy" alt="Appetizers"
                      class="img-cover">
                  </figure>
                </a>
            ...
            <li>
              <div class="service-card">
                ...
                <a href="#" class="has-before hover:shine">
                  <figure class="card-banner img-holder" style="--width: 285; --height: 336;">
                    <img src="./assets/images/testi-avatar.jpg" width="285" height="336" loading="lazy" alt="Drinks"
                      class="img-cover">
                  </figure>
                </a>
